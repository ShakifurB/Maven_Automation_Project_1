...
public class NewYorkLife_ContactUs extends Reusable_Annotations_Class {
    ...
    public NewYorkLife_ContactUs(WebDriver driver){
    ...
    @FindBy(xpath="//*[@class='nav-item collapsed']")
    WebElement ContactUs;

    public void ContactUs(int i){
        Reusable_Actions_POM_Loggers.clickByIndexAction(driver, ContactUs, logger,i,"Contact Us");
    }//end of ContactUs method
