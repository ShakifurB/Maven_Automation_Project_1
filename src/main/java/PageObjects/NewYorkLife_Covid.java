...
public class NewYorkLife_Covid extends Reusable_Annotations_Class {
    ...
    public NewYorkLife_Covid(WebDriver driver){
    ...
    @FindBy(xpath="//*[@class='button cmp-margin-bottom--none aem-GridColumn--small--none aem-GridColumn--default--none aem-GridColumn aem-GridColumn--offset--small--0 aem-GridColumn--x-small--4 aem-GridColumn--small--5 aem-GridColumn--offset--default--0 aem-GridColumn--default--4']")
    WebElement Covid19;

    public void Covid19(){
        Reusable_Actions_POM_Loggers.clickAction(driver, Covid19, logger, "Covid-19 button");
    }//end of Covid method
