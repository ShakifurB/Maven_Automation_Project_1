...
public class NewYorkLife_CompareChart extends Reusable_Annotations_Class {
    //we need to declare a local logger for each page object class so the logs can get added to the html report later
        ...
        //we need a constructor method as you can see below to create an instance of page object class, so we can make the class static later
         public NewYorkLife_CompareChart(WebDriver driver){
        ...
        @FindBy(xpath="//*[@class='cmp-table-row__cell']")
        WebElement BasicsWholeAndTermLife;


        public void BasicsWholeAndTermLife(int i ){
            Reusable_Actions_POM_Loggers.getTextByIndexAction(driver, BasicsWholeAndTermLife, i, logger, "Basics Whole Life");
        }//end of BasicsWholeAndTermLife method
