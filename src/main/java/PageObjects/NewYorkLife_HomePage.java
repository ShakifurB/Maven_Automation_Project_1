...
public class NewYorkLife_HomePage extends Reusable_Annotations_Class {
    ...
    public NewYorkLife_HomePage(WebDriver driver){
    ...
    @FindBy(xpath="//*[@class='d-flex order-lg-3']")
    WebElement KeywordSearch;

    public void KeywordSearch(){
        Reusable_Actions_POM_Loggers.clickAction(driver, KeywordSearch, logger, "Keyword Search");
    }//end of KeywordSearch method
